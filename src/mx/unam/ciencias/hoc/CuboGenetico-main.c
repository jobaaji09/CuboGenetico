...
gint cubo_genetico_main_main (gchar** args, int args_length1) {
	...
	if (_tmp0__length1 >= 2) {
		...
		CuboGeneticoAGeneticoCubo3x3* _tmp9_ = NULL;
		CuboGeneticoFFitness* _tmp10_ = NULL;
		CuboGeneticoFenoGeno* fenogeno = NULL;
		CuboGeneticoFenoGeno* _tmp11_ = NULL;
		CuboGeneticoCorrector* corrector = NULL;
		CuboGeneticoCorrector* _tmp12_ = NULL;
		CuboGeneticoSTorneo* storneo = NULL;
		CuboGeneticoSTorneo* _tmp13_ = NULL;
		CuboGeneticoCruzaUP* cruza = NULL;
		CuboGeneticoCruzaUP* _tmp14_ = NULL;
		CuboGeneticoMutacion* mutacion = NULL;
		CuboGeneticoMutacion* _tmp15_ = NULL;
		CuboGeneticoCuboGenetico* cubogene = NULL;
		CuboGeneticoFFitness* _tmp16_ = NULL;
		CuboGeneticoFenoGeno* _tmp17_ = NULL;
		CuboGeneticoCorrector* _tmp18_ = NULL;
		CuboGeneticoSTorneo* _tmp19_ = NULL;
		CuboGeneticoCruzaUP* _tmp20_ = NULL;
		CuboGeneticoMutacion* _tmp21_ = NULL;
		CuboGeneticoCuboGenetico* _tmp22_ = NULL;
		CuboGeneticoCuboGenetico* _tmp23_ = NULL;
		CuboGeneticoIndividuo* mg = NULL;
		CuboGeneticoCuboGenetico* _tmp24_ = NULL;
		CuboGeneticoIndividuo* _tmp25_ = NULL;
		CuboGeneticoIndividuo* _tmp26_ = NULL;
		CuboGeneticoIndividuo* _tmp27_ = NULL;
		FILE* _tmp28_ = NULL;
		CuboGeneticoIndividuo* _tmp29_ = NULL;
		gchar* _tmp30_ = NULL;
		gchar* _tmp31_ = NULL;
		CuboGeneticoAGeneticoCubo3x3* _tmp32_ = NULL;
		CuboGeneticoIndividuo* _tmp33_ = NULL;
		CuboGeneticoAGeneticoFenotipo* _tmp34_ = NULL;
		CuboGeneticoAGeneticoFenotipo* _tmp35_ = NULL;
		gchar** _tmp36_ = NULL;
		gint _tmp36__length1 = 0;
		gchar** _tmp37_ = NULL;
		gint _tmp37__length1 = 0;
		CuboGeneticoAGeneticoCubo3x3* _tmp38_ = NULL;
		CuboGeneticoIndividuo* _tmp39_ = NULL;
		gdouble _tmp40_ = 0.0;
		gdouble _tmp41_ = 0.0;
		_tmp1_ = args;
		...
		_tmp9_ = cubo;
		_tmp10_ = cubo_genetico_ffitness_new (_tmp9_);
		ffitness = _tmp10_;
		_tmp11_ = cubo_genetico_feno_geno_new (194);
		fenogeno = _tmp11_;
		_tmp12_ = cubo_genetico_corrector_new (170);
		corrector = _tmp12_;
		_tmp13_ = cubo_genetico_storneo_new (27);
		storneo = _tmp13_;
		_tmp14_ = cubo_genetico_cruza_up_new (10, 0.7);
		cruza = _tmp14_;
		_tmp15_ = cubo_genetico_mutacion_new (144, 0.4);
		mutacion = _tmp15_;
		_tmp16_ = ffitness;
		_tmp17_ = fenogeno;
		_tmp18_ = corrector;
		...
		_tmp20_ = cruza;
		_tmp21_ = mutacion;
		_tmp22_ = cubo_genetico_cubo_genetico_new (_tmp16_, _tmp17_, _tmp18_, _tmp19_, _tmp20_, _tmp21_, 125, 200);
		cubogene = _tmp22_;
		_tmp23_ = cubogene;
		cubo_genetico_cubo_genetico_run (_tmp23_);
		_tmp24_ = cubogene;
		_tmp25_ = cubo_genetico_cubo_genetico_get_mejor (_tmp24_);
		_tmp26_ = _tmp25_;
		_tmp27_ = _g_object_ref0 (_tmp26_);
		mg = _tmp27_;
		_tmp28_ = stdout;
		_tmp29_ = mg;
		_tmp30_ = cubo_genetico_individuo_to_string (_tmp29_);
		_tmp31_ = _tmp30_;
		fprintf (_tmp28_, "Mejor de la generacion :\n%s", _tmp31_);
		_g_free0 (_tmp31_);
		_tmp32_ = cubo;
		_tmp33_ = mg;
		_tmp34_ = cubo_genetico_individuo_get_fenotipo (_tmp33_);
		_tmp35_ = _tmp34_;
		_tmp36_ = cubo_genetico_agenetico_fenotipo_get_fenotipo (_tmp35_, &_tmp36__length1);
		_tmp37_ = _tmp36_;
		_tmp37__length1 = _tmp36__length1;
		cubo_genetico_agenetico_cubo3x3_giraCaras (_tmp32_, _tmp37_, _tmp37__length1);
		_tmp38_ = cubo;
		_tmp39_ = mg;
		_tmp40_ = cubo_genetico_individuo_get_fitness (_tmp39_);
		_tmp41_ = _tmp40_;
		cubo_genetico_agenetico_cubo3x3_dibuja (_tmp38_, _tmp41_);
		_g_object_unref0 (mg);
		...
		FILE* _tmp42_ = NULL;
		_tmp42_ = stdout;
		fprintf (_tmp42_, "Falta el archov de entrada\n");
	}
	result = 0;
	return result;
}
