...
CuboGeneticoCuboGenetico* cubo_genetico_cubo_genetico_new (CuboGeneticoFFitness* ffitness, CuboGeneticoFenoGeno* fenogeno, CuboGeneticoSTorneo* sr, CuboGeneticoCruzaUP* cruza, CuboGeneticoMutacion* mutacion, gint semilla, gint tamp);
CuboGeneticoCuboGenetico* cubo_genetico_cubo_genetico_construct (GType object_type, CuboGeneticoFFitness* ffitness, CuboGeneticoFenoGeno* fenogeno, CuboGeneticoSTorneo* sr, CuboGeneticoCruzaUP* cruza, CuboGeneticoMutacion* mutacion, gint semilla, gint tamp);
...
CuboGeneticoCuboGenetico* cubo_genetico_cubo_genetico_construct (GType object_type, CuboGeneticoFFitness* ffitness, CuboGeneticoFenoGeno* fenogeno, CuboGeneticoSTorneo* sr, CuboGeneticoCruzaUP* cruza, CuboGeneticoMutacion* mutacion, gint semilla, gint tamp) {
	...
	gint _tmp2_ = 0;
	CuboGeneticoCriador* _tmp3_ = NULL;
	CuboGeneticoSTorneo* _tmp4_ = NULL;
	CuboGeneticoSTorneo* _tmp5_ = NULL;
	CuboGeneticoCruzaUP* _tmp6_ = NULL;
	CuboGeneticoCruzaUP* _tmp7_ = NULL;
	CuboGeneticoMutacion* _tmp8_ = NULL;
	...
	_tmp1_ = ffitness;
	_tmp2_ = semilla;
	_tmp3_ = cubo_genetico_criador_new (_tmp0_, _tmp1_, _tmp2_);
	_cubo_genetico_criador_unref0 (self->priv->criador);
	self->priv->criador = _tmp3_;
	_tmp4_ = sr;
	_tmp5_ = _cubo_genetico_storneo_ref0 (_tmp4_);
	_cubo_genetico_storneo_unref0 (self->priv->sr);
	self->priv->sr = _tmp5_;
	_tmp6_ = cruza;
	_tmp7_ = _g_object_ref0 (_tmp6_);
	_g_object_unref0 (self->priv->cruza);
	self->priv->cruza = _tmp7_;
	_tmp8_ = mutacion;
	_tmp9_ = _g_object_ref0 (_tmp8_);
	_g_object_unref0 (self->priv->mutacion);
	self->priv->mutacion = _tmp9_;
	_tmp10_ = tamp;
	self->priv->tamp = _tmp10_;
	return self;
}


CuboGeneticoCuboGenetico* cubo_genetico_cubo_genetico_new (CuboGeneticoFFitness* ffitness, CuboGeneticoFenoGeno* fenogeno, CuboGeneticoSTorneo* sr, CuboGeneticoCruzaUP* cruza, CuboGeneticoMutacion* mutacion, gint semilla, gint tamp) {
	return cubo_genetico_cubo_genetico_construct (CUBO_GENETICO_TYPE_CUBO_GENETICO, ffitness, fenogeno, sr, cruza, mutacion, semilla, tamp);
}
